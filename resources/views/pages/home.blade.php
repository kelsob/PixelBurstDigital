<x-app-layout>
    ...
    <!-- Fixed animated pixels overlay -->
    <div class="fixed inset-0 z-0" id="pixel-animation"></div>
                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                    <div class="lg:col-span-7">
                        <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">Digital Solutions<br></span>
                        ...
                        <div class="mt-6 space-y-4 sm:space-y-0 sm:flex sm:space-x-4">
                            <a href="{{ route('services') }}" 
                               class="button-glow inline-flex items-center px-6 py-3 border border-transparent text-base font-semibold rounded-md text-black bg-blue-400 hover:bg-blue-500 md:text-lg">
                                Explore Services
                            </a>
                            <a href="{{ route('contact') }}" 
                               class="button-glow inline-flex items-center px-6 py-3 border border-transparent text-base font-semibold rounded-md text-white bg-gray-800/80 hover:bg-gray-700 backdrop-blur-sm md:text-lg">
                                Start a Project
                            </a>
                        </div>
                    ...
                    <div class="hidden lg:block lg:col-span-4">
                        <div class="relative transform translate-x-8">
                            ...
                            <div class="code-container p-6 pb-0 transform rotate-2">
                                <pre class="text-blue-400 text-sm m-0 p-0">
                                    <code id="typewriter-code" class="block text-left"></code>
                                </pre>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-border rounded-2xl p-12">
                    ...
                    <div class="mt-20 grid grid-cols-1 gap-12 lg:grid-cols-2">
                        <a href="{{ route('services') }}#web-development" 
                           class="group relative bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg hover:bg-gray-700/50 transition-all duration-300 transform hover:-translate-y-1">
